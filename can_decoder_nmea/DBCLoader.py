...
class DBCLoader(object):
    ...
    def _multiplexed_signal_loader_complex(self, muxer_signal: canmatrix.Signal,
                                           dbc_signals: Sequence[canmatrix.Signal]) -> Signal:
        # Convert root signal.
    ...
    def _multiplexed_signal_loader_simple(self, muxer_signal: canmatrix.Signal,
                                          dbc_signals: Sequence[canmatrix.Signal]) -> Signal:
        # Convert root signal.
        multiplexed_signal = self._signal_loader(muxer_signal)
